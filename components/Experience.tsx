    ...
    <section className="space-y-10 py-20">
      ...
      <div className="space-y-4">
        {EXPERIENCES.map((exp) => (
          <div
            key={exp.id}
            className="relative p-6 md:p-8 rounded-3xl border border-white/5 bg-white/5 flex flex-col items-center lg:flex-row lg:items-start justify-between gap-6"
          >
            <div className="space-y-4 max-w-xl text-center lg:text-left w-full">
              <div className="flex items-center justify-center lg:justify-between gap-4">
                ...
                <Briefcase className="absolute top-6 right-6 lg:static w-5 h-5 text-gray-500" />
              </div>
